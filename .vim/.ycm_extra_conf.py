...
def FlagsForFile( filename , **kwargs ):
  flags =   [
            ...
            '-I/Users/a3f/dl/wireshark/build',
            '-isystem', '/usr/local/Cellar/glib/2.54.3/include/glib-2.0',
            '-isystem', '/usr/local/Cellar/glib/2.54.3/lib/glib-2.0/include',
            '-isystem', '/usr/local/Cellar/hidapi/0.8.0-rc1/include/hidapi',
            '-isystem', '/opt/local/lib/perl5/5.26/darwin-thread-multi-2level/CORE',
            '-I', 'include',
            '-I.'
            '-I', '../include',
            '-I', './include',
