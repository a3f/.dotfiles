...
while (my $n = <>) {
    ...
    say "\t${pfx}SPEED_HIGH (200 MHz)"    if (($n >> 6)  & 3) == 3;
    say "\t${pfx}DSE_260ohm"    if (($n >> 3)  & 7) == 1;
    say "\t${pfx}DSE_130ohm"    if (($n >> 3)  & 7) == 2;
    say "\t${pfx}DSE_87ohm"     if (($n >> 3)  & 7) == 3;
    say "\t${pfx}DSE_65ohm"     if (($n >> 3)  & 7) == 4;
    say "\t${pfx}DSE_52ohm"     if (($n >> 3)  & 7) == 5;
    say "\t${pfx}DSE_43ohm"     if (($n >> 3)  & 7) == 6;
    say "\t${pfx}DSE_37ohm"     if (($n >> 3)  & 7) == 7;
